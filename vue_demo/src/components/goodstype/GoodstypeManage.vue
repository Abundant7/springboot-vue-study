  ...
  export default {
    ...
    methods: {
      loadGet() {
        ...
        axios.get('http://localhost:8090/goodstype/list').then(res => res.data).then(res => {
          console.log(res)
          this.tableData = res
        })
      ...
      loadPost() {
        axios.post('http://localhost:8090/goodstype/listPage', {
      ...
      doSave() {
        axios.post('http://localhost:8090/goodstype/save', this.form
        ).then(res => res.data).then(res => {
          console.log(res)
          if (res.code == 200) {
            this.$message({
      ...
      doMod() {
        axios.post('http://localhost:8090/goodstype/update', this.form
        ).then(res => res.data).then(res => {
          console.log(res)
          if (res.code == 200) {
            this.$message({
      ...
      del(id) {
        ...
        axios.get('http://localhost:8090/goodstype/del?id=' + id
        ).then(res => res.data).then(res => {
          console.log(res)
          if (res.code == 200) {
            this.$message({
